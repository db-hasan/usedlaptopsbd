                    ...
                    <div class="dropdown user">
                        ...
                        <ul class="dropdown-menu " style="width: 250px;">
                            <li class="dropdown-item text-end">
                                <RouterLink class="dropdown-link" to="#">15 Notifications</RouterLink>
                            </li>
                            <li class="dropdown-item">
                                <div class="d-flex justify-content-between">
                                    <RouterLink class="dropdown-link" to="#"><i class="fa-solid fa-chart-column"></i> Stock
                                        Report
                                    </RouterLink>
                                    <small>3 mins</small>
                                </div>
                            ...
                            <li class="dropdown-item">
                                <div class="d-flex justify-content-between">
                                    <RouterLink class="dropdown-link" to="#"><i class="fa-solid fa-heart-circle-minus"></i>
                                        User
                                        message
                                    </RouterLink>
                                    <small>3 mins</small>
                            ...
                            <li class="dropdown-item">
                                <div class="d-flex justify-content-between">
                                    <RouterLink class="dropdown-link" to="#"><i class="fa-solid fa-cart-plus"></i> Sales
                                        Report
                                    </RouterLink>
                                    <small>3 mins</small>
                                </div>
                            ...
                            <li class="dropdown-item text-center">
                                <RouterLink class="dropdown-link" to="#">See All Notifications</RouterLink>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="text-end pe-5">
                    <div class="dropdown user">
                        ...
                        <ul class="dropdown-menu ">
                            <li class="dropdown-item">
                                <RouterLink class="dropdown-link" to="#"><i class="fas fa-cog"></i> Manage Account
                                </RouterLink>
                            </li>
                            <li class="dropdown-item">
                                <RouterLink class="dropdown-link" to="#"><i class="fas fa-user-tie"></i> My Profile
                                </RouterLink>
                            </li>
                            <li class="dropdown-item">
                                <RouterLink class="dropdown-link" to="#"><i class="fas fa-sign-out-alt"></i> Logout
                                </RouterLink>
                            </li>
                        </ul>
                    </div>
